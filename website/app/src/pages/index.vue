<template>
    <NuxtLayout>
        <header id="hero" class="h-screen flex items-center justify-center relative">
            <div class="text-center z-10">
                <h1 ref="heroTitle" class="text-6xl md:text-8xl font-bold mb-6 opacity-0">
                    <span class="text-rose-400">Maxence</span><br>
                    <span class="text-white">Bessi</span>
                </h1>
                <p ref="heroSubtitle" class="text-xl md:text-2xl text-gray-300 mb-8 opacity-0">
                    Développeur Full Stack & Passionné
                </p>
                <RouterLink to="/projets">
                    <template #default>
                        <button ref="heroButton"
                            class="bg-rose-600 hover:bg-rose-700 px-8 py-3 rounded-lg font-semibold transition-colors opacity-0">
                            Voir mes projets
                        </button>
                    </template>
                </RouterLink>
            ...
            <div ref="heroBackground" class="absolute inset-0 opacity-20">
                <div class="absolute top-1/4 left-1/4 w-64 h-64 bg-rose-500 rounded-full blur-3xl"></div>
                    ...
                    <div ref="aboutContent" class="space-y-6">
                        ...
                        <div class="space-y-6">
                            <p class="text-lg text-gray-300 leading-relaxed transform translate-y-8 opacity-0"
                                ref="aboutText1">
                                Développeur passionné avec une expertise dans les technologies Web modernes.
                                Je crée de belles applications fonctionnelles qui résolvent des problèmes du monde réel.
                            </p>
                            <p class="text-lg text-gray-300 leading-relaxed transform translate-y-8 opacity-0"
                                ref="aboutText2">
                                Tout en utilisant des outils puissants comme Nuxt, Typescript et Spring Boot,
                                je m'efforce de produire un code propre et maintenable.
                            </p>
                        </div>
        ...
        <section id="projects"
            ...
            <div class="container mx-auto px-6 flex flex-col md:flex-row items-center justify-center h-full">
                <div class="w-full md:w-1/2 h-full flex flex-col justify-center items-start pr-0 md:pr-12 z-10">
                    <h2 ref="projectsTitle" class="text-4xl md:text-5xl font-bold mb-8 text-rose-400">Mes Projets</h2>
                    <div v-for="(project, idx) in sortedProjects" :key="project.name" v-show="idx === currentProject"
                        class="group">
                        <div
                            class="project-card relative overflow-hidden bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-rose-400 transition-all duration-300">
                            <div
                            ...
                            <div class="relative z-10 w-full min-w-80">
                                <h3 class="text-2xl font-semibold text-white mb-2">{{ project.name }}</h3>
                                ...
                                <RouterLink v-if="project.slug" :to="`/projets/${project.slug}`"
                                    class="inline-block mt-2 text-rose-400 hover:underline font-semibold">
                                    Voir le projet &rarr;
                                </RouterLink>
                            </div>
                        </div>
        ...
        <section id="career" class="min-h-[75vh] py-40 relative overflow-hidden flex items-center justify-center">
            <div class="container mx-auto px-6 relative z-10 flex flex-col items-center mx-auto">
