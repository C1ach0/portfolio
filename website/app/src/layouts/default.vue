<template>
    <nav ref="navbar" class="fixed top-0 w-full z-50 bg-black/80 backdrop-blur-sm border-b border-black">
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-between items-center">
                <RouterLink to="/" class="text-2xl font-bold text-rose-400">
                    Maxence Bessi
                </RouterLink>
                <!-- Desktop Navigation -->
                <div class="hidden md:flex space-x-8 text-white">
                    <RouterLink to="/" class="nav-link hover:text-rose-400 transition-colors cursor-pointer">
                        Accueil
                    </RouterLink>
                    <RouterLink to="/a-propos" class="nav-link hover:text-rose-400 transition-colors cursor-pointer">
                        A Propos
                    </RouterLink>
                    <RouterLink to="/projets" class="nav-link hover:text-rose-400 transition-colors cursor-pointer">
                        Projets
                    </RouterLink>
                    <RouterLink to="/contact" class="nav-link hover:text-rose-400 transition-colors cursor-pointer">
                        Contact
                    </RouterLink>
                </div>
    ...
    <footer id="contact" v-if="showFooter" class="py-20 bg-black">
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="py-10 flex flex-wrap gap-4 items-center justify-center">
                <a v-if="about.links.github" :href="about.links.github" target="_blank" class="rounded-lg w-10 h-10 flex flex-col items-center justify-center hover:scale-105 ease-in duration-150 bg-white">
                    <UIcon name="mdi-github" class="w-7 h-7 text-black"/>
                </a>
                <a v-if="about.links.linkedin" :href="about.links.linkedin" target="_blank" class="rounded-lg w-10 h-10 flex flex-col items-center justify-center hover:scale-105 ease-in duration-150 bg-blue-500">
                    <UIcon name="mdi-linkedin" class="w-7 h-7"/>
                </a>
                <a v-if="about.links.x" :href="about.links.x" target="_blank" class="rounded-lg w-10 h-10 flex flex-col items-center justify-center hover:scale-105 ease-in duration-150 bg-white">
                    <UIcon name="ri-twitter-x-fill" class="w-7 h-7 text-black"/>
                </a>
                <a v-if="about.links.discord" :href="about.links.discord" target="_blank" class="rounded-lg w-10 h-10 flex flex-col items-center justify-center hover:scale-105 ease-in duration-150 bg-blue-600">
